...
#pragma warning restore
    ...
    public void ChangeInputValue()
    {
        ...
        m_FreeLook.m_YAxis.m_MaxSpeed = m_Slider.value;
    }

    public void OnBecomeActive()
    {
        m_Slider.value = m_FreeLook.m_YAxis.m_MaxSpeed;
        m_Input.text = m_FreeLook.m_YAxis.m_MaxSpeed.ToString();
    }
    ...
    private void Update()
    {
        ...
        transform.position = new Vector3(Screen.width / 4 + Screen.width / 2, transform.position.y, transform.position.z);
